    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900/60 backdrop-blur-xl py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="w-full max-w-[400px] animate-fade-in-up">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Create an account</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Join SIWES Finder and secure your placement.</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm">
          ...
          <div className="flex p-1 bg-gray-100 dark:bg-slate-900/60 backdrop-blur-xl rounded-lg mb-6 relative border border-gray-200/50 dark:border-gray-800">
            <div 
              className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-white dark:bg-gray-800 rounded-md shadow-sm transition-transform duration-300 ease-out ${role === 'employer' ? 'translate-x-[calc(100%+8px)]' : 'translate-x-0'}`} 
            />
            <button
              type="button"
              onClick={() => setRole('student')}
              className={`flex-1 py-1.5 text-xs font-semibold relative z-10 transition-colors ${role === 'student' ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}
            >
              Student
            </button>
            <button
              ...
              className={`flex-1 py-1.5 text-xs font-semibold relative z-10 transition-colors ${role === 'employer' ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}
            >
              Employer
            </button>
          </div>
